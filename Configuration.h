...
#define STRING_CONFIG_H_AUTHOR "(fastriker)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "myEnder-3-Pro" __DATE__ " " __TIME__
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 50 }
