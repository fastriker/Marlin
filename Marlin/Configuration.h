...
#define STRING_CONFIG_H_AUTHOR "(fastriker, my Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "my Ender-3 Pro"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  39.45
    #define DEFAULT_Ki   4.35
    #define DEFAULT_Kd  89.34
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 95.92
  #define DEFAULT_bedKi 18.41
  #define DEFAULT_bedKd 333.27
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 66 }
